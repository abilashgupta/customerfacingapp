import 'package:customer_face/Home/drawer.dart';
import 'package:customer_face/Home/enddrawer.dart';
import 'package:customer_face/Home/ordershistory.dart';
import 'package:customer_face/Home/ordersreceived.dart';
import 'package:customer_face/Home/viewmenu.dart';
import 'package:flutter_switch/flutter_switch.dart';
import 'package:flutter/material.dart';

class Associate extends StatefulWidget {
  @override
  _AssociateState createState() => _AssociateState();
}

class _AssociateState extends State<Associate> {
  bool status = false;
  @override
          ...
          Align(
            ...
            child: Padding(
              ...
              children: [
                ...
                Text('some delicious food, Arunachala',style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.bold),),
              ],
              ),
            ),
          ),
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: (){
                    ...
                    MaterialPageRoute(builder: (context) => OrdersReceived()));
                  },
                  child: Container(
                    width: 300,
                    height: 100,
